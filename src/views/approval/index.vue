<template>
  <div class="container">
    ...
    <div style="height: 90%;" v-html="content" />
...
import { getApproval, updateApproval } from '@/api/common'
...
export default {
  ...
  methods: {
    ...
    async saveContent() {
      try {
        await updateApproval({ content: this.editorContent }) // Save the updated content
