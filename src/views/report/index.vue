<template>
  <div class="container">
    <h1 style="text-align: center;">企业考察报告</h1>
    ...
    <el-table :data="tableData" style="margin-top: 20px;width: 60%; margin: 0 auto;">
      ...
      <el-table-column prop="title" label="标题" width="1000">
        <template slot-scope="scope">
          <router-link :to="`/report/detail/${scope.row.id}`" style="color: #000; text-decoration: none;">{{ scope.row.title }}</router-link>
        </template>
      </el-table-column>
    ...
    <el-pagination
      ...
      @current-change="fetchReportData"
...
export default {
  ...
  data() {
    return {
      ...
      text_type: 5, // Text type for the TinyMCE editor
      page: 1,
      limit: 10,
      total: 0,
      title: ''
